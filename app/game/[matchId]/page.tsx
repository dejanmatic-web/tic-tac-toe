...
const SOCKET_URL =
    ...
    "https://xy-game-socket-server-production.up.railway.app";
const PLATFORM_URL =
...
function GameContent() {
    ...
    useEffect(() => {
        // Connect with credentials to send HTTP-only cookies
        const newSocket: GameSocket = io(SOCKET_URL, {
            withCredentials: true, // Required for HTTP-only cookies to be sent cross-origin
            transports: ["websocket", "polling"], // Ensure polling fallback works with cookies
        });
        ...
        // Wait for connection before joining (cookies are sent during handshake)
        newSocket.on("connect", () => {
            // Token is read from HTTP-only cookies on the server side
            ...
            <GameContainer>
                ...
                >
                    ...
                    <p style={{ color: "#666", marginBottom: "1rem" }}>
                        Playing as: <strong>{myPlayer.symbol}</strong> (
                        {myPlayer.username})
                    </p>
                    <Spinner />
                </motion.div>
    ...
    const isLocked =
        !!roomState.winner || !isMyTurn || roomState.gameStatus !== "playing";
            ...
            >
                ...
                >
                    <PlayerCard
                        ...
                        isActive={
                            roomState.currentPlayer === "X" && !roomState.winner
                        }
                    ...
                    <PlayerCard
                        ...
                        isActive={
                            roomState.currentPlayer === "O" && !roomState.winner
                        }
        ...
        <motion.div
            ...
            style={{
                ...
                backgroundColor: isActive
                    ...
                    : "transparent",
                border: isMe
                    ? `2px solid ${symbol === "X" ? "#667eea" : "#764ba2"}`
